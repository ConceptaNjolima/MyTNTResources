...
2. Make a change in the index.html file and fill it with some starter code:
...
3. to follow the git workflow, we need to complete stagging for the changes
    * Invoke the command either View -> Command Palette or `Ctrl+Shift+P. (Cmd+Shift+P for Mac OS)`
    * Type / select `"Git: stage all changes"`.


4. Show the Source Control tab and the file diffs.
...
5. After stagging is Committing changes
 ...
 6. show how to read the git log view
...
9. Room discussion - What worked? Where did you get stuck?
